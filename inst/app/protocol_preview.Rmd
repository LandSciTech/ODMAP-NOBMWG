...
cat("<p><b>Authors: </b>", paste(authors$df$first_name, authors$df$middle_name, authors$df$last_name, collapse = ", "), "</p>", sep = "")
...
for(i in 1:nrow(odmap_dict_rmd)){
  ...
  switch(odmap_dict_rmd$element_type[i],
         ...
         model_utility = knit_model_utility(odmap_dict_rmd$element_id[i]))
}
